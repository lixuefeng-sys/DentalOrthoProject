 ...
 * @brief   extract polygonal data based on geometric connectivity keep the original points
 * @warning now works correctly only on largest region (default) mode
 *
 * NonDestructiveConnectivityFilter is a filter that extracts cells that
 ...
 * polygonal data.
 *
 * The behavior of NonDestructiveConnectivityFilter can be modified by turning
...
#ifndef NonDestructiveConnectivityFilter_h
#define NonDestructiveConnectivityFilter_h
...
class NonDestructiveConnectivityFilter : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(NonDestructiveConnectivityFilter, vtkPolyDataAlgorithm);
   ...
   */
  static NonDestructiveConnectivityFilter* New();
...
protected:
  NonDestructiveConnectivityFilter();
  ~NonDestructiveConnectivityFilter() override;
...
private:
  NonDestructiveConnectivityFilter(const NonDestructiveConnectivityFilter&) = delete;
  void operator=(const NonDestructiveConnectivityFilter&) = delete;
};

/**
 * Return the method of extraction as a string.
 */
inline const char* NonDestructiveConnectivityFilter::GetExtractionModeAsString()
{
