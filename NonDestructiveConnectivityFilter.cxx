...
vtkStandardNewMacro(NonDestructiveConnectivityFilter);

// Construct with default extraction mode to extract largest regions.
NonDestructiveConnectivityFilter::NonDestructiveConnectivityFilter()
{
...
int NonDestructiveConnectivityFilter::RequestData(vtkInformation* vtkNotUsed(request),
...
//          this->PointIds->InsertId(i, id);
          ...
          // RainSia:: use original points ids
          id = pts[i];
          this->PointIds->InsertId(i, id);
...
//
void NonDestructiveConnectivityFilter::TraverseAndMark()
{
...
//------------------------------------------------------------------------------
int NonDestructiveConnectivityFilter::IsScalarConnected(vtkIdType cellId)
{
  double s;
...
int NonDestructiveConnectivityFilter::GetNumberOfExtractedRegions()
{
  return this->RegionSizes->GetMaxId() + 1;
}

// Initialize list of point ids/cell ids used to seed regions.
void NonDestructiveConnectivityFilter::InitializeSeedList()
{
  this->Modified();
  this->Seeds->Reset();
}
...
void NonDestructiveConnectivityFilter::AddSeed(int id)
{
  this->Modified();
...
void NonDestructiveConnectivityFilter::DeleteSeed(int id)
{
  this->Modified();
...
void NonDestructiveConnectivityFilter::InitializeSpecifiedRegionList()
{
  this->Modified();
...
void NonDestructiveConnectivityFilter::AddSpecifiedRegion(int id)
{
  this->Modified();
...
void NonDestructiveConnectivityFilter::DeleteSpecifiedRegion(int id)
{
  this->Modified();
  this->SpecifiedRegionIds->DeleteId(id);
}

void NonDestructiveConnectivityFilter::PrintSelf(ostream& os, vtkIndent indent)
{
