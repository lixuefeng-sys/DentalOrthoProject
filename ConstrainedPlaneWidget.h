...
#ifndef ConstrainedPlaneWidget_h
#define ConstrainedPlaneWidget_h
...
class ConstrainedPlaneWidget : public vtkPolyDataSourceWidget
{
public:
  /**
   * Instantiate the object.
   */
  static ConstrainedPlaneWidget* New();

  vtkTypeMacro(ConstrainedPlaneWidget, vtkPolyDataSourceWidget);
  ...
  void LimitMovement(enum Movement movement);

protected:
  ConstrainedPlaneWidget();
  ~ConstrainedPlaneWidget() override;
  ...
  void ConstrainedTranslate(double* p1, double* p2);
...
private:
  ConstrainedPlaneWidget(const ConstrainedPlaneWidget&) = delete;
  void operator=(const ConstrainedPlaneWidget&) = delete;
};

#endif  // ConstrainedPlaneWidget_H
